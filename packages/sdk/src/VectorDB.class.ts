...
for (const provider of Object.keys(TVectorDBProvider)) {
    VectorDB[provider] = (namespace: string, VectorDBSettings?: any, candidate?: AccessCandidate) =>
        new VectorDBInstance(TVectorDBProvider[provider], { ...VectorDBSettings, namespace }, candidate);
}
