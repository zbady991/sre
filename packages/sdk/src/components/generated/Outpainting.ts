...
export interface TOutpaintingSettings {
    name?: string;
    ctaButton?: string;
}

export type TOutpaintingInputs = {
    [key: string]: any;
};

export type TOutpaintingOutputs = {
    [key: string]: any;
};

export function Outpainting(settings?: TOutpaintingSettings, agent?: Agent) {    
    const { name, ...settingsWithoutName } = settings || {};
    const dataObject: any = { 
        name: settings?.name || 'Outpainting', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const _out: TOutpaintingOutputs = {
        // No outputs defined
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TOutpaintingInputs) => void,
    };
