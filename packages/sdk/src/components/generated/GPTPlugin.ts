...
export interface TGPTPluginSettings {
    model?: string;
    openAiModel: string;
...
export function GPTPlugin(settings?: TGPTPluginSettings, agent?: Agent) {    
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TGPTPluginInputs) => void,
    };
