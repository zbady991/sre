...
import { TCustomLLMModel, TLLMConnectorParams, TLLMModel, TLLMProvider } from '@sre/types/LLM.types';
...
export class LLMInstance extends SDKObject {
    ...
    constructor(
        private _providerId: TLLMProvider,
        private _modelSettings: TLLMInstanceParams,
