...
export interface TImageToImageSettings {
    name?: string;
    ctaButton?: string;
}

export type TImageToImageInputs = {
    [key: string]: any;
};
...
export function ImageToImage(settings?: TImageToImageSettings, agent?: Agent) {    
    ...
    const dataObject: any = { 
        name: settings?.name || 'ImageToImage', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TImageToImageInputs) => void,
    };
