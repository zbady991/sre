...
export interface TMultimodalLLMSettings {
    name?: string;
    /** Prompt */
    prompt: string;
    model: string;
...
export type TMultimodalLLMInputs = {
    [key: string]: any;
};
...
export function MultimodalLLM(settings?: TMultimodalLLMSettings, agent?: Agent) {    
    ...
    const dataObject: any = { 
        name: settings?.name || 'MultimodalLLM', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TMultimodalLLMInputs) => void,
    };
