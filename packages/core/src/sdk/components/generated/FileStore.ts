...
export interface TFileStoreSettings {
    /** Name */
    name?: string;
    /** TTL */
    ttl?: number;
...
export function FileStore(settings?: TFileStoreSettings, agent?: Agent) {    
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TFileStoreInputs) => void,
    };
