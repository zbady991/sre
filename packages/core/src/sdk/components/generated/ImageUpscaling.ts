...
export interface TImageUpscalingSettings {
    name?: string;
    ctaButton?: string;
}

export type TImageUpscalingInputs = {
    [key: string]: any;
};
...
export function ImageUpscaling(settings?: TImageUpscalingSettings, agent?: Agent) {    
    ...
    const dataObject: any = { 
        name: settings?.name || 'ImageUpscaling', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TImageUpscalingInputs) => void,
    };
