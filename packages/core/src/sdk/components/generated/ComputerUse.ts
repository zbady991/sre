...
export interface TComputerUseSettings {
    name?: string;
    /** Prompt */
    prompt: string;
    /** Environment */
...
export type TComputerUseInputs = {
    [key: string]: any;
};
...
export function ComputerUse(settings?: TComputerUseSettings, agent?: Agent) {    
    ...
    const dataObject: any = { 
        name: settings?.name || 'ComputerUse', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TComputerUseInputs) => void,
    };
