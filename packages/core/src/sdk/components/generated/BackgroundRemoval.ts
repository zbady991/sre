...
export interface TBackgroundRemovalSettings {
    name?: string;
    ctaButton?: string;
}

export type TBackgroundRemovalInputs = {
    [key: string]: any;
};
...
export function BackgroundRemoval(settings?: TBackgroundRemovalSettings, agent?: Agent) {    
    ...
    const dataObject: any = { 
        name: settings?.name || 'BackgroundRemoval', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TBackgroundRemovalInputs) => void,
    };
