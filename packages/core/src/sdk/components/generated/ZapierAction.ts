...
export interface TZapierActionSettings {
    name?: string;
    actionName: string;
    actionId: string;
    logoUrl?: string;
...
export type TZapierActionInputs = {
    [key: string]: any;
};
...
export function ZapierAction(settings?: TZapierActionSettings, agent?: Agent) {    
    ...
    const dataObject: any = { 
        name: settings?.name || 'ZapierAction', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TZapierActionInputs) => void,
    };
