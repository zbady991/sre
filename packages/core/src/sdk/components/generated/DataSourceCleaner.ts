...
export interface TDataSourceCleanerSettings {
    name?: string;
    /** namespace */
    namespaceId?: string;
    /** source identifier */
...
export type TDataSourceCleanerInputs = {
    [key: string]: any;
};
...
export function DataSourceCleaner(settings?: TDataSourceCleanerSettings, agent?: Agent) {    
    ...
    const dataObject: any = { 
        name: settings?.name || 'DataSourceCleaner', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TDataSourceCleanerInputs) => void,
    };
