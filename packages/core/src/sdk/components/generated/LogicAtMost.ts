...
export interface TLogicAtMostSettings {
    name?: string;
    /** Maximum Inputs */
    maxSetInputs?: string;
}

export type TLogicAtMostInputs = {
    [key: string]: any;
};

export type TLogicAtMostOutputs = {
    [key: string]: any;
};

export function LogicAtMost(settings?: TLogicAtMostSettings, agent?: Agent) {    
    const { name, ...settingsWithoutName } = settings || {};
    const dataObject: any = { 
        name: settings?.name || 'LogicAtMost', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const _out: TLogicAtMostOutputs = {
        // No outputs defined
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TLogicAtMostInputs) => void,
    };
