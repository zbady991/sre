...
export interface TDataSourceIndexerSettings {
    namespace?: string;
    /** source identifier */
    id?: string;
    /** label */
...
export type TDataSourceIndexerInputs = {
    [key: string]: any;
};
...
export function DataSourceIndexer(settings?: TDataSourceIndexerSettings, agent?: Agent) {    
    ...
    const dataObject: any = { 
        name: settings?.name || 'DataSourceIndexer', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TDataSourceIndexerInputs) => void,
    };
