...
export interface TAPIEndpointSettings {
    name?: string;
    endpoint: string;
    method?: 'POST' | 'GET';
    summary?: string;
...
export type TAPIEndpointInputs = {
    [key: string]: any;
};

export function APIEndpoint(settings?: TAPIEndpointSettings, agent?: Agent) {    
    const { name, ...settingsWithoutName } = settings || {};
    const dataObject: any = { 
        name: settings?.name || 'APIEndpoint', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TAPIEndpointInputs) => void,
    };
