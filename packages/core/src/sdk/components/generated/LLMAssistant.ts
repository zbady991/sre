...
export interface TLLMAssistantSettings {
    name?: string;
    model: string;
    /** Behavior */
    behavior?: string;
...
export type TLLMAssistantInputs = {
    [key: string]: any;
};
...
export function LLMAssistant(settings?: TLLMAssistantSettings, agent?: Agent) {    
    ...
    const dataObject: any = { 
        name: settings?.name || 'LLMAssistant', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TLLMAssistantInputs) => void,
    };
