...
export interface TAgentPluginSettings {
    agentId: string;
    openAiModel?: string;
...
export type TAgentPluginInputs = {
    [key: string]: any;
};
...
export function AgentPlugin(settings?: TAgentPluginSettings, agent?: Agent) {    
    ...
    const dataObject: any = { 
        name: settings?.name || 'AgentPlugin', 
        settings: {
            ...settingsWithoutName 
        }
    };
    ...
    const wrapper = {
         ...
         */        
        in: component.inputs.bind(component) as (inputs: TAgentPluginInputs) => void,
    };
