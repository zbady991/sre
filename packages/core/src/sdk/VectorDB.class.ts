...
import { TVectorDBProvider, TVectorDBProviderInstances, TVectorDBSettingsFor } from '@sre/sdk/types/generated/VectorDB.types';
import { IVectorDBRequest, VectorDBConnector } from '@sre/IO/VectorDB.service/VectorDBConnector';
import { EventEmitter } from 'events';
import { AccessCandidate } from '@sre/Security/AccessControl/AccessCandidate.class';
import { DEFAULT_TEAM_ID, TAccessRole } from '@sre/types/ACL.types';

import { printStackTrace } from '@sre/utils/general.utils';
...
export class VectorDBInstance extends EventEmitter {
    ...
    constructor(providerId: TVectorDBProvider, VectorDBSettings?: any, candidate?: AccessCandidate) {
        ...
        if (!connector.valid) {
            connector = ConnectorService.init(TConnectorService.VectorDB, providerId, providerId, VectorDBSettings) as VectorDBConnector;
