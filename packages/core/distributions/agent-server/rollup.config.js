...
const devCJSConfig = {
    input: './distributions/agent-server/src/app.ts',
    output: {
        file: './distributions/agent-server/dist/agent-server.dev.cjs', // CommonJS output
...
const devESBundleConfig = {
    ...
    output: {
        ...
        dir: 'distributions/agent-server/dist',
        inlineDynamicImports: true,
        entryFileNames: 'agent-server.dev-bundle.js',
    },
    plugins: [
...
const devESConfig = {
    ...
    output: {
        ...
        //Comment this line and uncomment the following lines if you need ES bundle
        file: 'distributions/agent-server/dist/agent-server.dev.js',
    },
    plugins: [
        json(),
        filenameReplacePlugin(),
...
const prodConfig = {
    input: 'distributions/agent-server/src/app.ts',
    output: {
        file: 'distributions/agent-server/dist/agent-server.prod.js',
        format: 'es',
        sourcemap: true,
    },
    plugins: [
