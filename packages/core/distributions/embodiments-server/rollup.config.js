...
const devCJSConfig = {
    input: './distributions/embodiments-server/src/app.ts',
    output: {
        file: './distributions/embodiments-server/dist/embodiments-server.dev.cjs', // CommonJS output
...
const devESBundleConfig = {
    ...
    output: {
        ...
        dir: 'distributions/embodiments-server/dist',
        inlineDynamicImports: true,
        entryFileNames: 'embodiments-server.dev-bundle.js',
    },
    plugins: [
...
const devESConfig = {
    input: './distributions/embodiments-server/app.ts',
    output: {
        format: 'es',
        sourcemap: true,

        //Comment this line and uncomment the following lines if you need ES bundle
        file: 'distributions/embodiments-server/dist/embodiments-server.dev.js',
    },
    plugins: [
        json(),
        filenameReplacePlugin(),
...
const prodConfig = {
    input: 'distributions/embodiments-server/src/app.ts',
    output: {
        file: 'distributions/embodiments-server/dist/embodiments-server.prod.js',
        format: 'es',
        sourcemap: true,
    },
    plugins: [
